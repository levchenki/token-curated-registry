...
export const VotingItem = ({votingItem}: IVotingItemProps) => {
        ...
        <div className='flex flex-col w-full h-fit items-center px-4 pb-5 py-2 justify-between rounded-md border'>
            ...
            <div className='grid grid-cols-2 w-full items-center justify-center mt-8'>
                <div className='grid grid-cols-2 gap-2'>
                    ...
                    <p>Started at: </p>
                    <p className='underline'>{votingItem.startDate.toLocaleDateString()}</p>
                    <p>End at: </p>
                    <p className='underline'>{votingItem.endDate.toLocaleDateString()}</p>
                </div>
                <div className='grid grid-cols-2 gap-2 self-end'>
                    ...
                    <Button variant='outline' disabled={isDisabled(votingItem)} className='hover:bg-destructive'
                            size='sm'>
                        Deny
                    </Button>
                </div>
